			...
			module = {
				...
				instantiate: function() {
					...
					if (settings.values) {
						...
						module.setValuePosition(settings.values[0], thumb);
						module.setValuePosition(settings.values[1], rthumb);
						// event listeners
				...
				sanitize: function() {
					...
					if (values && (typeof settings.values[0] != 'number' || typeof settings.values[1] != 'number')) {
