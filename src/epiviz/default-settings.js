...
epiviz.Config.SETTINGS = {
  ...
  workspacesDataProvider: sprintf(
    ...
    "empty",
    ""
  ), //TODO: Fill in (in site-settings.js)
  ...
  chartSettings: {
    ...
    "epiviz.plugins.charts.ScatterPlot": {
      ...
      decorations: ["epiviz.ui.charts.decoration.ChartColorByRowCodeButton"]
    },
