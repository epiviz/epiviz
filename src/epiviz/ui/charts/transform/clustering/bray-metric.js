...
goog.provide('epiviz.ui.charts.transform.clustering.BrayMetric');

/**
 * @constructor
 * @implements {epiviz.ui.charts.transform.clustering.ClusteringMetric}
 */
epiviz.ui.charts.transform.clustering.BrayMetric = function() {};
 ...
 * @returns {?number}
 */
epiviz.ui.charts.transform.clustering.BrayMetric.prototype.distance = function(item1, item2) {
 ...
 * @returns {string}
 */
epiviz.ui.charts.transform.clustering.BrayMetric.prototype.id = function() { return 'bray'; };
