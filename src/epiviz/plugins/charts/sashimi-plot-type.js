 ...
 */
  ...
  */
 epiviz.plugins.charts.SashimiPlotType.prototype = epiviz.utils.mapCopy(epiviz.ui.charts.TrackType.prototype);
 epiviz.plugins.charts.SashimiPlotType.constructor = epiviz.plugins.charts.SashimiPlotType;
  ...
  */
 epiviz.plugins.charts.SashimiPlotType.prototype.createNew = function (id, container, properties) {
  ...
  * @returns {string}
  */
 epiviz.plugins.charts.SashimiPlotType.prototype.chartHtmlAttributeName = function () {
   return 'sashimi';
 };
  ...
  * @returns {boolean}
  */
 epiviz.plugins.charts.SashimiPlotType.prototype.isRestrictedToRangeMeasurements = function () { return true; };
 
 /**
  * @returns {function(epiviz.measurements.Measurement): boolean}
  */
 epiviz.plugins.charts.SashimiPlotType.prototype.measurementsFilter = function () { return function (m) { return m.type() == epiviz.measurements.Measurement.Type.FEATURE; }; };
