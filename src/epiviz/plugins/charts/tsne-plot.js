...
goog.provide('epiviz.plugins.charts.TSNEPlot');
 ...
 * @constructor
 */
epiviz.plugins.charts.TSNEPlot = function(id, container, properties) {
 ...
 */
epiviz.plugins.charts.TSNEPlot.prototype = epiviz.utils.mapCopy(epiviz.ui.charts.Plot.prototype);
epiviz.plugins.charts.TSNEPlot.constructor = epiviz.plugins.charts.TSNEPlot;

/**
 * @protected
 */
epiviz.plugins.charts.TSNEPlot.prototype._initialize = function() {
    // Call super
 ...
 * @private
 */
epiviz.plugins.charts.TSNEPlot.prototype._drawCircles = function(data, dimx, dimy, key) {
    var self = this;
    var Axis = epiviz.ui.charts.Axis;
    var circleRadius = Math.max(1, this.customSettingsValues()[epiviz.plugins.charts.TSNEPlotType.CustomSettings.CIRCLE_RADIUS_RATIO] * Math.min(this.width(), this.height()));
    ...
    var abLine = this.customSettingsValues()[epiviz.plugins.charts.TSNEPlotType.CustomSettings.AB_LINE];
    ...
    var colorbylabel = this.customSettingsValues()[epiviz.plugins.charts.TSNEPlotType.CustomSettings.COLOR_BY];
 ...
 */
epiviz.plugins.charts.TSNEPlot.prototype.colorLabels = function() {
 ...
 * @protected
 */
epiviz.plugins.charts.TSNEPlot.prototype._drawAxes = function(xScale, yScale, xTicks, yTicks, svg, width, height, margins) {
    ...
    var xEntries = this._legend
        ...
        .text(function(m, i) {
            return m;
            //  + " (% Variance Explained = " + self._variance_labels[0] + ")";
        });
    ...
    var yEntries = this._legend
        ...
        .text(function(m, i) {
            return m;
            //   + " (% Variance Explained = " + self._variance_labels[1] + ")";
        });
...
epiviz.plugins.charts.TSNEPlot.prototype.transformData = function(range, data) {
