 ...
 */
epiviz.plugins.charts.StackedBlocksTrack.prototype = epiviz.utils.mapCopy(epiviz.ui.charts.Track.prototype);
epiviz.plugins.charts.StackedBlocksTrack.constructor = epiviz.plugins.charts.StackedBlocksTrack;
 ...
 */
epiviz.plugins.charts.StackedBlocksTrack.prototype.draw = function(range, data, slide, zoom) {
 ...
 * @private
 */
epiviz.plugins.charts.StackedBlocksTrack.prototype._drawBlocks = function(range, data, slide, zoom) {
  ...
  var minBlockDistance = this.customSettingsValues()[epiviz.plugins.charts.StackedBlocksTrackType.CustomSettings.MIN_BLOCK_DISTANCE];

  var colorLabel = this.customSettingsValues()[epiviz.plugins.charts.StackedBlocksTrackType.CustomSettings.BLOCK_COLOR_BY];

  var useColorBy = this.customSettingsValues()[epiviz.plugins.charts.StackedBlocksTrackType.CustomSettings.USE_COLOR_BY];
  ...
  selection
    ...
    .attr('y', function(b) { return b.seriesIndex * seriesBlockHeight; })
    .attr('width', function(b) { return xScale(b.end + 1) - xScale(b.start); })
    .attr('height', function(b) { return seriesBlockHeight; });
 ...
 */
epiviz.plugins.charts.StackedBlocksTrack.prototype.setColors = function(colors) {
