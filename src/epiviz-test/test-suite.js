...
epiviztest.TestSuite.prototype.addChart = function(chartTypeName, range, measurements, customSettings, useCache, finishCallback) {
  ...
  var chartProperties = new epiviz.ui.charts.ChartProperties(t.defaultWidth(), t.defaultHeight(), t.defaultMargins(), new epiviz.ui.controls.VisConfigSelection(measurements), t.defaultColors(), null, customSettings, t.customSettingsDefs());
  var measurementIds = {};
